        ...
        <nav class="nav">
            ...
            <div class="dropdown pb-4 ps-2">
                ...
                <ul class="dropdown-menu dropdown-menu-light shadow">
                    <li><a class="dropdown-item nav_link" href="../change-password.php"><i class="fas fa-lock "></i><span class="nav_name"> Đổi mật khẩu</span></a></li>
                    <li><a class="dropdown-item nav_link" href="../logout.php"><i class="fas fa-sign-out-alt "></i><span class="nav_name"> Thoát</span></a></li>
                </ul>
            </div>
        </nav>
