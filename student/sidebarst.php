        ...
        <nav class="nav">
            ...
            <div class="dropdown pb-4 ps-3">
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="https://avatars.githubusercontent.com/u/90234580?s=96&v=4" alt="hugenerd" class=" header_img rounded-circle">
                ...
                <li><a class="dropdown-item" href="../change-password.php"><span class="nav_name"><i class="fas fa-lock me-3"></i>Đổi mật khẩu</span></a></li>
                    ...
                    <li><a class="dropdown-item" href="../logout.php"><i class="fas fa-sign-out-alt me-3"></i> Thoát</a>
                    </li>
                </ul>
            </div>
        </nav>
