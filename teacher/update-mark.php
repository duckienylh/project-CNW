        ...
        ?>
                <form method="post">
                    <div class="form-group row">
                        <label for="empPosition" class="col-sm-2 col-form-label">Họ và Tên</label>
                        <div class="col-sm-10">
                            <input type="text" disabled class="form-control" name="st-name" value="<?php echo $row['st_name']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="empPosition" class="col-sm-2 col-form-label">Điểm 15'</label>
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" name="mini-test" value="<?php echo $row['ma_mini_test']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="empPosition" class="col-sm-2 col-form-label">Điểm giữa kì</label>
                        <div class="col-sm-10">
                            <input type="text"  class="form-control" name="hour-test" value="<?php echo $row['ma_hour_test']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="empPosition" class="col-sm-2 col-form-label">Điểm cuối kì</label>
                        <div class="col-sm-10">
...
if(isset($_POST['btnupdate']))
    {
        ...
        $avg2 = round($avg, 2);
        $sql = "UPDATE `marks` SET `ma_mini_test`='$mini',`ma_hour_test`='$hour',`ma_final_exam`='$final',`ma_avarage`='$avg2'";
